    ...
    return (
        <section className="relative flex items-center justify-center gap-20 bg-gradient-to-r from-black to-gray-800 py-10">
            ...
            <div className="w-1/2 space-y-4">
                ...
                <p className="text-gray-400 ">Passionate about UI/UX, I thrive on crafting digital experiences that seamlessly blend aesthetics and functionality. Every pixel represents a canvas for storytelling, making user-centric design a journey of creativity.</p>
